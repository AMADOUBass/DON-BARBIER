# Le Don Barbier — Guide de démarrage
...
# 3. Créer la base de données PostgreSQL (locale si besoin)
createdb donbarbier
...
|---|---|---|
| contact@donbarbier.beauty | DonBarbier2026! | ADMIN |
| grace@donbarbier.beauty | BarberTest2026! | STYLIST |
