...
import { Calendar, ImageIcon, LayoutDashboard } from "lucide-react";
  ...
  return (
    <div className="min-h-screen bg-brand-black">
      ...
      <header className="fixed top-0 left-0 right-0 z-40 bg-brand-charcoal border-b border-brand-charcoal/80 h-14 sm:h-16 flex items-center px-4 sm:px-6 gap-3">
        <Link href="/" className="font-display text-base sm:text-lg font-bold text-brand-gold mr-2 sm:mr-4 shrink-0">Don Barbier</Link>
