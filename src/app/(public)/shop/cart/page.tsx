...
export default function CartPage() {
  ...
  if (!mounted) {
    return (
      <div className="min-h-screen bg-brand-black pt-0 pb-16 flex items-center justify-center">
  ...
  if (items.length === 0) {
    return (
      <div className="min-h-screen bg-brand-black pt-0 pb-16">
                ...
                {paymentMethod === "INTERAC" && (
                  <div className="p-3 bg-brand-gold/5 border border-brand-gold/20 rounded-lg">
                    <p className="text-[10px] text-brand-muted leading-relaxed">
                      Envoyez votre virement à <strong className="text-brand-gold">Don Barbierf@gmail.com</strong>. Votre commande sera expédiée après réception.
                    </p>
                  </div>
                )}
              </div>
