    ...
    <div className="min-h-screen pt-0 pb-16 bg-brand-black">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              <div className="space-y-5">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <a href="tel:+14189299552" className="text-brand-muted text-sm mt-1 hover:text-brand-gold transition-colors block">
                      (418) 929-9552
                    </a>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <a href="mailto:contact@donbarbier.beauty" className="text-brand-muted text-sm mt-1 hover:text-brand-gold transition-colors block">
        ...
        <div className="mt-10 rounded-2xl overflow-hidden border border-brand-charcoal h-72 shadow-lg">
          <iframe
            title="Don Barbier — Carte"
            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2732.1234567890!2d-71.2291!3d46.8372!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x4cb896a4a45e7d3f%3A0x1234567890abcdef!2s2880+Av.+Duval%2C+Qu%C3%A9bec%2C+QC+G1L+4N3!5e0!3m2!1sfr!2sca!4v1234567890"
            width="100%"
            height="100%"
