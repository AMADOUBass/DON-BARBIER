    ...
    <div className="min-h-screen pt-0 pb-16 bg-brand-black">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          ...
          <h1 className="section-title">L&apos;Élite du Grooming Afro</h1>
          <div className="divider-gold" />
          <p className="mt-4 text-brand-muted max-w-xl mx-auto">
            Chaque expert est spécialisé et certifié dans son domaine pour 
            vous offrir une expérience de coiffure inégalée à Québec.
          </p>
        </div>
