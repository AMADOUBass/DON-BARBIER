      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-32 grid lg:grid-cols-2 gap-16 items-center">
        ...
        <div>
          ...
          <motion.h1
            ...
            className="font-display text-4xl sm:text-5xl md:text-6xl lg:text-8xl font-bold text-brand-beige leading-[1.1] text-balance mb-4"
          >
            DON <span className="text-brand-gold">BARBIER</span>
          </motion.h1>
          ...
          <motion.p
            ...
            className="text-2xl sm:text-3xl text-brand-gold font-light tracking-[0.4em] mb-12"
          >
            BÉNITSOITLAMAIN
          </motion.p>
          ...
          <motion.p
            ...
            className="mt-6 text-base sm:text-lg text-brand-muted leading-relaxed max-w-lg mb-8"
          >
            L&apos;excellence du grooming au service de toutes les textures. 
            Spécialistes de la maîtrise Afro et experts en coupes haute précision, 
            nous redéfinissons l&apos;art de la coiffure pour l&apos;homme moderne.
          </motion.p>
          ...
          >
            <Link href="/booking" className="btn-primary w-full sm:w-auto justify-center gap-2 text-base px-10 py-5">
              <Calendar className="w-5 h-5" />
              Réserver l&apos;Excellence
            </Link>
            <Link href="/shop" className="btn-outline w-full sm:w-auto justify-center text-base px-10 py-5">
              Explorer le Shop <ArrowRight className="w-5 h-5" />
            </Link>
          </motion.div>
